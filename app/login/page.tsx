...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      {verified && (
        <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 rounded-md text-green-700 dark:text-green-400 text-sm mb-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-gray-900 dark:text-white rounded-md hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors disabled:opacity-50 mb-6"
      >
